...
|YEAR, SYEAR|The year spelled out in English. The S version causes BC dates to display with a minus sign prefix.|			|YYYY, SYYYY|The four-digit year. The S version causes BC dates to display with a minus sign prefix.|					
